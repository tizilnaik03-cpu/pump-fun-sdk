...
const channels = [
  ...
  { path: '/live/launches', label: 'Live Launches', emoji: '🟢', preview: 'WebSocket token launch terminal', unread: false },
  { path: '/live/trades', label: 'Live Trades', emoji: '📊', preview: 'Real-time trade analytics', unread: false },
